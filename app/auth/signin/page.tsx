        ...
        <Card className="p-8 shadow-2xl border-0 bg-white/80 backdrop-blur-sm">
          <div className="space-y-6">
            ...
            <Button
              ...
              className="w-full py-6 bg-gradient-to-r from-gray-800 to-gray-900 hover:from-gray-900 hover:to-black text-white rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 flex items-center justify-center gap-3 group"
            >
            ...
            <div className="grid grid-cols-2 gap-3">
              <Button
                variant="outline"
                className="py-6 rounded-xl border-2 hover:bg-gray-50 transition-all duration-300 hover:scale-105"
                disabled
              >
